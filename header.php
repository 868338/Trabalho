<?php 
$base_url = ' http://localhost/zacarias2-main/';
?>
...
<html lang="en">
  ...
  <head>
    <!-- Page Meta Tags-->
    <base href="http://localhost/zacarias2-main/">
    <meta charset="utf-8" />
      ...
      <div class="container-fluid">
        ...
        >
          <div class="d-flex align-items-center">
            <svg
              class="f-w-5 me-2 text-primary d-flex align-self-center lh-1"
            ...
            <span class="fw-black text-uppercase tracking-wide fs-6 lh-1"
              >Apollo</span
            >
          </div>
        </a>
        ...
        >
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-none d-sm-flex dropdown mx-1">
              ...
              >
                ...
                >
                  ...
                  <span class="badge bg-success-faded text-success rounded-pill"
                    >4 new</span
                  >
                </div>
                  ...
                  <div data-pixr-simplebar>
                    <ul class="list-unstyled m-0 pb-4">
                      <li class="d-flex py-2 align-items-start">
                        <button
                          class="btn-icon bg-primary-faded text-primary fw-bolder me-3"
                        >
                          O
                        </button>
                        <div
                        ...
                        >
                          <div>
                            ...
                            <p class="text-muted lh-1 mb-2 small">
                              Placed by John Doe at 11:23 AM
                            </p>
                          </div>
                          <small
                            class="text-muted text-uppercase tracking-wide fw-bold fs-xs"
                            >2min</small
                          >
                        </div>
                      </li>
                      <li class="d-flex py-2 align-items-start">
                        ...
                        >
                          <div>
                            ...
                            <p class="text-muted lh-1 mb-2 small">
                              Hi Jack, can we setup a meeting...
                            </p>
                          </div>
                          <small
                            class="text-muted text-uppercase tracking-wide fw-bold fs-xs"
                      ...
                      <li class="d-flex py-2 align-items-start">
                        ...
                        >
                          <div>
                            ...
                            <p class="text-muted lh-1 mb-2 small">
                              Monthly staff review starts in...
                            </p>
                          </div>
                          <small
                            class="text-muted text-uppercase tracking-wide fw-bold fs-xs"
                      ...
                      <li class="d-flex py-2 align-items-start">
                        ...
                        >
                          <div>
                            ...
                            <p class="text-muted lh-1 mb-2 small">
                              Placed by Sally Smith at 10:07 AM
                            </p>
                          </div>
                          <small
                            class="text-muted text-uppercase tracking-wide fw-bold fs-xs"
                ...
                <div>
                  <a
                    class="dropdown-item text-primary fw-bolder text-center border-top pt-3"
                    href="#"
                    >See more &rarr;</a
                  >
                </div>
                    ...
                    <div class="row g-2 pb-3">
                      <div class="col-4 h-100">
                        ...
                        >
                          ...
                          <span class="small fw-bolder text-body mb-0 mt-3"
                            >Figma</span
                          >
                        </a>
                      </div>
            ...
            <div class="dropdown ms-1">
              ...
              <ul
                class="dropdown-menu dropdown-md dropdown-menu-end"
    ...
    <main id="main">
      ...
      <div class="bg-white border-bottom py-3 mb-5">
        ...
        >
          ...
          <div
            class="d-flex justify-content-end align-items-center mt-3 mt-md-0"
          >
            <a class="btn btn-sm btn-primary" href="#"
              ><i class="ri-add-circle-line align-bottom"></i> New Project</a
            >
            <a class="btn btn-sm btn-primary-faded ms-2" href="#"
              ><i class="ri-settings-3-line align-bottom"></i> Settings</a
            >
            <a class="btn btn-sm btn-secondary-faded ms-2 text-body" href="#"
              ><i class="ri-question-line align-bottom"></i> Help</a
            >
          </div>
        </div>
      </div>
      ...
      <div class="simplebar-wrapper">
        <div data-pixr-simplebar>
          <div class="pb-6">
            ...
            >
              <a
                class="navbar-brand lh-1 border-0 m-0 d-flex align-items-center"
                href="./index.html"
              >
                <div class="d-flex align-items-center">
                  <svg
              ...
              <i
                class="ri-close-circle-line ri-lg close-menu text-muted transition-all text-primary-hover me-4 cursor-pointer"
              ></i>
            </div>
            <!-- / Mobile Logo-->
            ...
            <ul class="list-unstyled mb-6">
              ...
              <li class="menu-item">
                <a class="d-flex align-items-center" href="./index.html">
                  ...
                  <span class="menu-link">
                    Dashboard
                    <span
                      class="badge bg-success-faded text-success pb-1 ms-2 align-middle rounded-pill"
                      >beta</span
                    >
                  </span></a
                >
              ...
              <li class="menu-item">
                <a class="d-flex align-items-center" href="user/index.php">
                  <span class="menu-icon">
                    <svg
                      version="1.1"
                      xmlns="http://www.w3.org/2000/svg"
                      ...
                      x="0px"
                      y="0px"
                      viewBox="0 0 489.902 489.902"
                      style="enable-background: new 0 0 489.902 489.902"
                    >
                      <path
                        fill="currentColor"
                        opacity="0.5"
                        d="M349.2,178.251l113.6-45.9c-37.7-72.7-110.1-124-195.6-131.8v122.5C301.8,129.651,330.9,149.851,349.2,178.251z"
                      />
                      <path
                        fill="currentColor"
                        opacity="0.75"
                        d="M121.3,244.751c0-60.7,43.6-110.8,101.1-121.3V0.551C98,11.851,0,116.851,0,244.751c0,54.8,17.9,105.4,48.2,146.2
                                           l91.4-81.7C128.3,290.251,121.3,268.051,121.3,244.751z"
                      />
                      <path
                        fill="currentColor"
                        d="M479.5,173.551l-113.6,45.9c1.6,8.2,2.7,16.3,2.7,24.9c0,68.1-55.2,123.7-123.7,123.7c-28.4,0-54.8-9.7-75.4-26.1
                    ...
                    Usuarios
                    <span
                      class="badge bg-danger-faded text-danger pb-1 ms-2 align-middle rounded-pill"
                      >new</span
                    >
                  </span></a
                >
              ...
              <li class="menu-item">
                <a
                  ...
                  data-bs-target="#collapseMenuItemPages"
                  aria-expanded="false"
              ...
              <li class="menu-item">
                <a
                  ...
                  href="#"
                  data-bs-toggle="collapse"
                  data-bs-target="#collapseMenuItemUsers"
                  aria-expanded="false"
              ...
              <li class="menu-item">
                <a
                  ...
                  href="#"
                  data-bs-toggle="collapse"
                  data-bs-target="#collapseMenuItemUI"
                  aria-expanded="false"
